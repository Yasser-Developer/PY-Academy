    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_code', models.CharField(blank=True, max_length=12, null=True, unique=True, verbose_name='کد دانش\u200cآموزی')),
                ('xp', models.PositiveIntegerField(default=0, verbose_name='امتیاز تجربه (XP)')),
                ('level', models.PositiveSmallIntegerField(default=1, editable=False, verbose_name='سطح')),
                ('is_vip', models.BooleanField(default=False, verbose_name='عضو ویژه (VIP)')),
